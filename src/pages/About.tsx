      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            zIndex: 0,
            backgroundImage: "url(https://images.unsplash.com/photo-1556910103-1c02745aae4d?q=85&w=1920)",
        ...
        <div className="section-container">
          ...
          <div className="grid-3 reveal-children">
            <div className="about-value-card">
              <div className="about-value-bg" style={{backgroundImage: "url(https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=85&w=600&h=400&fit=crop)"}} />
              <div className="about-value-content">
                <div className="icon"><i className="ri-restaurant-line"></i></div>
            ...
            <div className="about-value-card">
              <div className="about-value-bg" style={{backgroundImage: "url(https://images.unsplash.com/photo-1555396273-367ea4eb4db5?q=85&w=600&h=400&fit=crop)"}} />
              <div className="about-value-content">
                <div className="icon"><i className="ri-money-dollar-circle-line"></i></div>
            ...
            <div className="about-value-card">
              <div className="about-value-bg" style={{backgroundImage: "url(https://images.unsplash.com/photo-1559339352-11d035aa65de?q=85&w=600&h=400&fit=crop)"}} />
              <div className="about-value-content">
                <div className="icon"><i className="ri-moon-line"></i></div>
